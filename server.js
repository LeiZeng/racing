...
//       socket.sockets.in(this.gameId).emit("remove player", {
//         id: this.id
//       });
//     }
...
//   socket.sockets.in(this.gameId).emit("start game on client", {
//     mapName: pendingGame.mapName,
...
//     player.numBombsAlive--;
//     socket.sockets.in(gameId).emit("detonate", {
...
//   socket.sockets.to(this.gameId).emit("place bomb", {
//     x: normalizedBombLocation.x,
//     y: normalizedBombLocation.y,
//     id: data.id
//   });
// };
//
...
//     player.bombCapacity++;
//   }
//   socket.sockets.in(this.gameId).emit("powerup acquired", {
//     acquiringPlayerId: this.id,
...
//     socket.sockets.in(gameId).emit("kill player", {
//       id: deadPlayerId
//     });
